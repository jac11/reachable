...
class Info_print:
       ...
       print(Y+"-To Scan all Subnet Use -PN <network/prefix>\n./reachable.py -PN 10.195.100.200/25")              
       print(R+"\t\t"+"="*20+'\n')
       print(Y+"-To Scan range of ips Use -PN <network/prefix> -S <Start>  -E <end>\n./reachable.py -PN 10.195.100.200/24 -S 240 -E 254 ")             
       print(R+"\t\t"+"="*20)       
       print(Y+"-To Scan one Host  Use  '-PH' <host ip>\n./reachable.py -PH 10.195.100.200/25\nor\n./reachable.py -PH 10.196.100.3")
       print(R+"\t\t"+"="*20)
       print(Y+"-To Save the output into file Use -O <file name>")
       print(Y+"./reachable.py -PN 10.195.100.200/24 -S 240 -E 254 -O report.txt") 
       print(R+"="*15)
       print()
