...
class Run :
        ...
        def args_command(self):
              ...
              if len(sys.argv)> 1 :
                   ...
                   print(R+"\t\t"+"="*20)
                   print(W+R+I+"-To Scan range of ips Use -N <network/prefix> -S <Start>  -E <end>\n"+Y+D+I+"sudo"+R+D+I+" ./reachable.py -N 10.195.100.200/24  -I eth0 -S 240 -E 254 ")               
                   print(W+"\t\t"+"="*20)
                   print(D+I+B+"-To Scan one Host  Use  '-H' <host ip>\n sudo ./reachable.py -H 10.195.100.200/25 -I eth0 \n"+Y+"or\n"+Y+" sudo"+R+" .reachable.py -H 10.196.100.3 -I wlan0")
                   print(Y+"\t\t"+"="*20)
                   print(B+"-To Save the output into file Use -O <file name>")
                   print("sudo ./reachable.py -N 10.195.100.200/24  -I eth0 -S 240 -E 254 -O report.txt"+S) 
                   print(Banner)
                   exit()
